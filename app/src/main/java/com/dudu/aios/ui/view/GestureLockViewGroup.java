...
import com.dudu.aios.ui.view.GestureLockView.Mode;
...
public class GestureLockViewGroup extends RelativeLayout {
        ...
        for (int i = 0; i < n; i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.GestureLockViewGroup_color_finger_up:
                    mFingerUpFaultColor = a.getColor(attr, mFingerUpFaultColor);
                    break;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mGestureLockViews == null) {
            ...
            mGestureLockViewWidth = (int) (3.7 * mWidth * 1.0f / (5 * mCount + 1));
            ...
            for (int i = 0; i < mGestureLockViews.length; i++) {
                ...
                mGestureLockViews[i] = new GestureLockView(getContext(),
                        ...
                        mFingerOnColor, mFingerUpFaultColor);
                ...
                if (i >= 0 && i < mCount)// 第一行
                {
                    topMargin = mMarginBetweenLockView / 14;
                }
                if (i % mCount == 0)// 第一列
                {
    ...
    private void changeItemMode(boolean isOk) {
