...
public class VehicleCheckResultView extends View {
    ...
    protected void onDraw(Canvas canvas) {
       ...
       /* //画背景的直线
        ...
        RectF oval = new RectF(0, 0, widthBg, 24);// 设置个新的长方形
        canvas.drawRoundRect(oval, 12, 12, paintBg);//第二个参数是x半径，第三个参数是y半径
        RectF oval1 = new RectF(0, 0, width, 24);// 设置个新的长方形
        canvas.drawRoundRect(oval1, 12, 12, paint);//第二个参数是x半径，第三个参数是y半径
    }
