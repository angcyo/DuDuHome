...
//	private int port = 5555;
    ...
    private StartNaviCallBack startNaviCallBack;
    private static Connection mConnection;
	public Connection(Context context) {
		mOnRecieveCallBackList = new ArrayList<OnRecieveCallBack>();
		mOnStateChangeCallBackList = new ArrayList<onSessionStateChangeCallBack>();
		mPersistentStorage = PersistentStorage.getInstance(context);
		important_msgList = new ArrayList<String>();
	}
	...
	public StartNaviCallBack getStartNaviCallBack() {
		return startNaviCallBack;
	}

	public void setStartNaviCallBack(StartNaviCallBack startNaviCallBack) {
		this.startNaviCallBack = startNaviCallBack;
	}
